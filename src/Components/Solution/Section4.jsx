...
const Section4 = () => {
  return (
    <div className="sosection4">
      <h2 className="pt-5  px-5 learn">Learn More About Our other Solutions</h2>
        ...
        <div className="px-5 py-3">
          <div className="seach px-3 mb-3 bg-light pb-4 text-center">
            ...
            <p>
              ...
              Necessitatibus iste, incidunt nulla pariatur, corporis iusto omnis
              repellat laborum quis vitae architecto, odit at optio ducimus
              reprehenderit libero. Sequi, aspernatur ipsa.
            </p>{" "}
